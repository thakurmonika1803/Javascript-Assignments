// Create a function that returns an array of employees from a random time from 1 to 2 seconds using async await.
...
const result = async () => {
    const employeePromise = await printEmployeeDetails()
    await sortAccordingToNames(employeePromise);
}
result();
